...
**Leia [design-guidelines.md](design-guidelines.md) antes de qualquer geração.** Contém diretrizes completas de design thinking, tipografia, cor, movimento e composição.
...
| -------------------------------------------------- | -------------------------------------------------------------------- | ------------------------- |
| [design-guidelines.md](design-guidelines.md)       | Diretrizes de design thinking e estética — leia antes de qualquer geração | Phases 1–3 (sempre)       |
| [design-systems/](design-systems/)                 | Sistemas de design pré-definidos com tokens, tipografia e regras concretas | Phase 2 (se solicitado)   |
