---
name: paper
description: Design inspirado em papel e impressão com cores mínimas, tipografia serifa/sans limpa e qualidades táteis de superfície.
license: MIT
metadata:
  author: typeui.sh
---

# Paper — Sistema de Design

## Missão

Estilo inspirado em papel e design gráfico impresso: minimal, limpo, com paleta restrita e tipografia que evoca a qualidade tátil do papel.

## Fundações de Estilo

- **Visual:** minimal, limpo
- **Tipografia:** escala 14/16/18/24/32/40 | Fontes: primary=Roboto, display=Montserrat, mono=PT Mono | pesos: 100–900
- **Paleta:** primary=#111111, secondary=#8B5CF6, success=#16A34A, warning=#D97706, danger=#DC2626, surface=#FFFFFF, text=#111827
