---
name: doodle
description: Estilo artesanal com doodles, fontes manuscritas e linhas imperfeitas para uma sensação lúdica e informal.
license: MIT
metadata:
  author: typeui.sh
---

# Doodle — Sistema de Design

## Missão

Estilo criativo, lúdico e informal que utiliza doodles, esboços, fontes manuscritas e linhas imperfeitas para criar conexão emocional e uma estética artística e crua.

## Fundações de Estilo

- **Visual:** playful
- **Tipografia:** escala 14/16/18/24/32/40 | Fontes: primary=Delius Swash Caps, display=Delius Swash Caps, mono=JetBrains Mono | pesos: 100–900
- **Paleta:** primary=#49B6E5, secondary=#263D5B, success=#16A34A, warning=#D97706, danger=#DC2626, surface=#FFFFFF, text=#111827
